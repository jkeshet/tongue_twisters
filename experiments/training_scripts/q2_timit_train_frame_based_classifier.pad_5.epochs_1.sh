...
sed "s/labels$/pad_$PAD.epcohs_$EPOCHS.scores/" config/timit_train_frame_based_classifier_1500_rest.labels > config/timit_train_frame_based_classifier_1500_rest.pad_$PAD.epcohs_$EPOCHS.scores
$BIN/PhonemeFrameBasedDecode \
	...
	-averaging \
	-mfcc_stats config/timit_mfcc.stats \
	-scores config/timit_train_frame_based_classifier_1500_rest.pad_$PAD.epcohs_$EPOCHS.scores \
...
$BIN/PhonemeFrameBasedDecode \
	...
	-averaging \
	-mfcc_stats config/timit_mfcc.stats \
	-scores config/timit_test_core.pad_$PAD.epcohs_$EPOCHS.scores \
...
# decode the all the test files
sed "s/labels$/pad_$PAD.epcohs_$EPOCHS.scores/" config/timit_test.labels > config/timit_test.pad_$PAD.epcohs_$EPOCHS.scores
$BIN/PhonemeFrameBasedDecode \
	-n $PAD \
	-kernel_expansion rbf3 \
	-sigma $SIGMA \
	-averaging \
	-mfcc_stats config/timit_mfcc.stats \
	-scores config/timit_test.pad_$PAD.epcohs_$EPOCHS.scores \
